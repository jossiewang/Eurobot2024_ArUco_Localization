...
int main(int argc, char** argv) {
    try {
        ...
        while (node.ok()){
            ...
            //translation average
            avg_transform.transform.translation.x = (tf_cam_map20.transform.translation.x + tf_cam_map21.transform.translation.x + tf_cam_map22.transform.translation.x + tf_cam_map23.transform.translation.x)/4;
            avg_transform.transform.translation.y = (tf_cam_map20.transform.translation.y + tf_cam_map21.transform.translation.y + tf_cam_map22.transform.translation.y + tf_cam_map23.transform.translation.y)/4;
            avg_transform.transform.translation.z = (tf_cam_map20.transform.translation.x + tf_cam_map21.transform.translation.x + tf_cam_map22.transform.translation.x + tf_cam_map23.transform.translation.x)/4;
            //rotation average
            ...
            average_rotation = tf2::slerp(average_rotation, q20, 1.0 / 4);
            ...
            average_rotation = tf2::slerp(average_rotation, q21, 1.0 / 4);
            ...
            average_rotation = tf2::slerp(average_rotation, q22, 1.0 / 4);
            ...
            average_rotation = tf2::slerp(average_rotation, q23, 1.0 / 4);
